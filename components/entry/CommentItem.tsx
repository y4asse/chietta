...
const CommentItem = async ({ comment, isMine }: { comment: NonNullable<CommentsType>[number]; isMine: boolean }) => {
  return (
    <div className="flex gap-2 py-3 border-b border-[#e7e7e7] dark:border-gray relative">
      <div className="w-[40px] h-[40px] md:w-[50px] md:h-[50px] border border-lightGray dark:border-gray rounded-full overflow-hidden hover:opacity-70 duration-200 transition-all">
